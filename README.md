...
```console
npm install @Gotipath/player timing-object
```
...
See this [demo app](https://salmoro.github.io/Gotipath-timing-object-demo/dist) which syncs video playback in real-time for all viewers.
...
```js
{
    cues: [
        {
            html: "<i>Here at Gotipath, there's always <br>one thing on our minds:</i>",
            text: "<i>Here at Gotipath, there's always ↵one thing on our minds:</i>"
        }
    ],
    kind: "captions",
    label: "English CC",
